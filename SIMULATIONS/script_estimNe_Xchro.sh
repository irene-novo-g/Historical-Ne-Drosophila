...
#script_estimNe_Xchro.sh <d> <EXP> <MS> <mig>
...
if [[ "$MS" == 0 ]] ; then
	mkdir -p $WDIR/estimNe_results/BPcircular.n100.exp$EXP.m$mig.L$LAMB.K$NCRO.s$AVEs.h$AVEh.X$CROX/
	DIR="estimNe_results/BPcircular.n100.exp$EXP.m$mig.L$LAMB.K$NCRO.s$AVEs.h$AVEh.X$CROX"
fi
if [[ "$MS" == 1 ]] ; then
	mkdir -p $WDIR/estimNe_results/BPoffspool.n100.exp$EXP.L$LAMB.K$NCRO.s$AVEs.h$AVEh.X$CROX/
	DIR="estimNe_results/BPoffspool.n100.exp$EXP.L$LAMB.K$NCRO.s$AVEs.h$AVEh.X$CROX"
fi
if [[ "$MS" == 2 ]] ; then
	mkdir -p $WDIR/estimNe_results/BPpanmixia.n100.exp$EXP.L$LAMB.K$NCRO.s$AVEs.h$AVEh.X$CROX/
	DIR="estimNe_results/BPpanmixia.n100.exp$EXP.L$LAMB.K$NCRO.s$AVEs.h$AVEh.X$CROX"
fi
...
cp POPFILE_N$NP.L$LAMB.K$NCRO.s$AVEs.h$AVEh.X$CROX $SCDIR/$SLURM_JOBID/popfile
cp DATAFILE_N$NP.L$LAMB.K$NCRO.s$AVEs.h$AVEh.X$CROX $SCDIR/$SLURM_JOBID/datafile
